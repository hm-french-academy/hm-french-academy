...
(function(){
 ...
 function mark(word,correct,lessonId){const d=read(),k=String(lessonId||'global')+'::'+String(word);const s=d[k]||{word:String(word),lessonId:lessonId||'global',seen:0,correct:0,wrong:0,next:0};s.seen++;correct?s.correct++:s.wrong++;s.next=Date.now()+(correct?3:0)*86400000;d[k]=s;write(d)}
