/* HM Academy — Unified multilingual runtime v4.6 — stable codes + dynamic selector binding */
(function(){'use strict';
...
const labelMap={ar:['ar','العربية','Arabe','Arabic'],fr:['fr','Français','French','Français'],en:['en','English','Anglais']};
let lang='ar',dict={ar:{},fr:{},en:{}},loaded=false;
const fallback={fr:{'العربية':'العربية','الفرنسية':'Français','الإنجليزية':'Anglais'},en:{'العربية':'Arabic','الفرنسية':'French','الإنجليزية':'English'}};
...
async function load(){try{const q='?v=20260820-i18n46',g=p=>fetch(p+q,{cache:'no-store'}).then(r=>r.ok?r.json():{});const [u,f,e]=await Promise.all([g('data/i18n/ui.json'),g('data/i18n/fr.json'),g('data/i18n/en.json')]);dict={ar:u.ar||{},fr:Object.assign({},u.fr||{},f||{}),en:Object.assign({},u.en||{},e||{})};loaded=true;}catch(e){}}
