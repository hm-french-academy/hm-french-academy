...
for(const forbidden of ['grade5-premium-engine-v6.js','grade5-stage-runtime-v1.js','grade5-route-lock-v1.js','grade5-games-entry-v1.js','grade5-game-bank.js','grade5-game-common.js','grade5-games.html'])if(html.includes(forbidden))fail(`legacy conflicting artifact referenced by lesson page: ${forbidden}`);
...
const assessment=fs.readFileSync(path.join(root,'grade5-interactive-assessment.html'),'utf8');for(const bad of ['grade5-game-bank.js','grade5-game-common.js','g5-t1-l01'])if(assessment.includes(bad))fail(`assessment contains legacy/L01 dependency: ${bad}`);
console.log(`Grade 5 Release QA: ${lessons.length} lessons; ${media.readyVideos}/${media.videoCount} videos; single-owner Premium Engine v7; independent assessment; legacy L01 game artifacts removed.`);
