...
for(const p of ['grade-5.html','grade-5-lesson-v3.html','scripts/grade5-premium-engine-v6.js','scripts/grade5-games-entry-v1.js','scripts/grade5-vocabulary-images-v1.js','scripts/grade5-stage-runtime-v1.js','data/lessons/grade-5/grade5-games.html'])if(!exists(p))fail(`missing ${p}`);
