...
const html=fs.readFileSync(path.join(root,'grade-5-lesson-v3.html'),'utf8');for(const n of ['learning-progress.js?build=20260820-144','grade5-fetch-cache.js?build=20260820-144','grade5-premium-engine-v6.js?build=20260820-144','grade5-games-entry-v1.js?build=20260820-144','grade5-vocabulary-images-v1.js?build=20260821-vocab1'])if(!html.includes(n))fail(`runtime pin ${n}`);
...
console.log(`Grade 5 Release QA: ${lessons.length} lessons; ${media.readyVideos}/${media.videoCount} videos; 6 games; package gate; runtime 144; vocabulary visuals; JSON envelopes normalized`);
