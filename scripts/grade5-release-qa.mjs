...
for(const p of ['grade-5.html','grade-5-lesson-v3.html','scripts/grade5-premium-engine-v6.js','scripts/grade5-games-entry-v1.js','scripts/grade5-vocabulary-images-v1.js','data/lessons/grade-5/grade5-games.html'])if(!exists(p))fail(`missing ${p}`);
...
const html=fs.readFileSync(path.join(root,'grade-5-lesson-v3.html'),'utf8');for(const n of ['learning-progress.js?build=20260820-144','grade5-fetch-cache.js?build=20260821-145','grade5-premium-engine-v6.js?build=20260821-145','grade5-games-entry-v1.js?build=20260821-145','grade5-vocabulary-images-v1.js?build=20260821-vocab1'])if(!html.includes(n))fail(`runtime pin ${n}`);
...
console.log(`Grade 5 Release QA: ${lessons.length} lessons; ${media.readyVideos}/${media.videoCount} videos; 6 games; package gate; runtime 145; vocabulary visuals; JSON envelopes normalized`);
