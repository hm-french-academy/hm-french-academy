...
(function(){
  ...
  if(isGrade5Lesson()&&!window.HMProgress&&document.readyState==='loading'){
    document.write('<script src="scripts/learning-progress.js?build=20260819-21"><\\/script>');
  }
  ...
  document.addEventListener('click',e=>{const b=e.target.closest('[data-audio],[data-speak-text]');if(b)playAudio(b,b);});
