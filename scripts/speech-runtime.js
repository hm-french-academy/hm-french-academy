...
(function(){
  ...
  function applyLessonVisualTheme(){
    ...
    const t=themes[id]||themes['grade8-u1-l1'];hero.dataset.lessonTheme=id;hero.style.background=`linear-gradient(135deg,${t.a},${t.b},${t.c})`;hero.style.boxShadow=`0 20px 50px ${t.b}33`;if(art.textContent!==t.icon)art.textContent=t.icon;if(art.getAttribute('aria-label')!==t.label)art.setAttribute('aria-label',t.label);if(art.title!==t.label)art.title=t.label;
  }
