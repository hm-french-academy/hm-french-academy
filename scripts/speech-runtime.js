...
(function(){
  ...
  function applyLessonVisualTheme(){
    ...
    const t=themes[id]||themes['grade8-u1-l1'];hero.dataset.lessonTheme=id;const bg=`linear-gradient(135deg,${t.a},${t.b},${t.c})`;if(hero.style.background!==bg)hero.style.background=bg;const shadow=`0 20px 50px ${t.b}33`;if(hero.style.boxShadow!==shadow)hero.style.boxShadow=shadow;if(art.textContent!==t.icon)art.textContent=t.icon;if(art.getAttribute('aria-label')!==t.label)art.setAttribute('aria-label',t.label);if(art.title!==t.label)art.title=t.label;
  }
  ...
  if(location.pathname.endsWith('/lesson.html')||location.pathname.endsWith('lesson.html')){const s=document.createElement('script');s.src='scripts/pronunciation-safe-runtime.js?v=20260816-pron-safe1';s.defer=true;document.head.appendChild(s);}
})();
