(function(){'use strict';
/* HM Academy — Universal Vocabulary System. Completion is delegated to the canonical lesson-complete flow. */
...
function boot(){enhance();const viewer=document.querySelector('#viewer');if(viewer){new MutationObserver(()=>enhance(document)).observe(viewer,{childList:true,subtree:true});}window.addEventListener('hm:lesson-rendered',()=>enhance());}
